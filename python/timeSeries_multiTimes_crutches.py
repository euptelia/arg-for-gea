...
#M3a cline one run
inPath_filePrefix = "/home/anadem/github/data/tskit_data/output/table/realistic_fpr_comparisons/Continuous_nonWF_M3b_glacialHistoryOptimum0_clineMap_mu1.0e-08_sigmaM0.01_sigmaW0.4_sigmaD0.03_mateD0.12_K17000_r1.0e-07/timeSeries/Continuous_nonWF_M3b_glacialHistoryOptimum0_clineMap_mu1.0e-08_sigmaM0.01_sigmaW0.4_sigmaD0.03_mateD0.12_K17000_r1.0e-07_seed1632624861947384517_tick"
...
times2 = np.array([0, 200, 300, 400, 800,
                  1000, 1100, 1200, 1300, 1400, 1800,
                  2000, 4000, 6000, 8000,
                  10000])
# times2 = np.array([0, 100, 200, 400, 600, 800,
...
for f in fileList:
    ...
    df_focal["lf_mut"] = df_focal["delta_LF_mut"] # delete this
    totalLF = sum(df_focal["delta_LF_mut"])
    LFs.append(totalLF)
    ...
    positive_lf_mut = df_focal["lf_mut"][df_focal["lf_mut"] > 0]

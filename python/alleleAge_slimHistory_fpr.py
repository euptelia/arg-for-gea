"""
Generate tables for comparing false positive rate of neutral alleles,
...
path_file_name = "/home/tianlin/Documents/github/data/slim_data/glacial_history/realistic_fpr_comparisons/M0a_smallLowVm_lowMig_clineMap_hyperMig/Continuous_nonWF_M0a_glacialHistoryOptimum0_clineMap_mu1.0e-08_sigmaM0.01_sigmaW0.4_sigmaD0.1_mateD0.24_K5000_r1.0e-07_seed3832511235450056785_tick110000.trees"
# Remove paths
...
sample_id = sorted(random.sample(range(mts.num_samples),
                                 sample_size))
...
# Extract frequency for a realistic sample
freq_subsample = []
num_samples = mts.num_samples
for v in mts.variants(samples=sample_id):
    for allele in np.arange(1, v.num_alleles):
...
# SFS of non-fixed/lost alleles in the subsample
...
np.savetxt(outPath + model_name + "_withNeutralMut_mutSeed" +
           ...
           myTable,
           header="ID, allele_age, allele_freq, effect_size, tau, p")

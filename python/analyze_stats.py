...
#Fst
#High Migration
fileList_highMig = glob.glob("/home/anadem/github/data/tskit_data/stats/fst/*HighMig*_Fst.tab")
...
print(np.mean(df_fst_highMig))
print(np.std(df_fst_highMig))
# stats.sem(df_fst_highMig)

#low Migration
fileList_lowMig = glob.glob("/home/anadem/github/data/tskit_data/stats/fst/*LowMig*_Fst.tab")
...
print(np.mean(df_fst_lowMig))
print(np.std(df_fst_lowMig))
# stats.sem(df_fst_lowMig)

#LF
fileList = glob.glob("/home/anadem/github/data/tskit_data/stats/lf/*LF.tab")
...
for df, name in zip(df_list_lf, fileList):
    ...
    df["modelName"] = name.strip().split("/")[-1].split(".")[0]
    print(stats.ttest_1samp(df[0], 0,alternative="two-sided"))
...
stats.ttest_ind(df_lf_highMig, df_lf_lowMig, equal_var=False)
...
stats.ttest_ind(df_lf_highPoly, df_lf_lowPoly, equal_var=False)

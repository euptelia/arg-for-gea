...
outBasePath = "/home/tianlin/Documents/github/data/tskit_data/output/table/realistic_fpr_comparisons/subsample500genome/"
...
np.savetxt(outPath + model_name + "_withNeutralMut_mutSeed" +
           ...
           myTable,
           header="ID, allele_age, allele_freq, effect_size, mean_LF, tau, p")

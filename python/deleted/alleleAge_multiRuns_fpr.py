...
my_alpha = 0.3
my_bins = 50
plt.hist(df_high["p"], bins=my_bins,
         color="darkblue", alpha=my_alpha,
         histtype="step",
         label="MAF>0.05")
plt.hist(df_low["p"], bins=my_bins,
         color="purple", alpha=my_alpha,
         histtype="step",
         label="0.01<MAF<0.05")
plt.hist(df_rare["p"], bins=my_bins,
...
plt.xlabel("P-values")
plt.ylabel("Count")
plt.savefig(figPath+model_name+"_p_hist_freq0.01to0.05.png",
            dpi=300)
plt.close()
...
plt.xlabel("P-values")
plt.ylabel("Count")
plt.savefig(figPath+model_name+"_p_hist_freqLessThan0.01.png",
            dpi=300)
plt.close()
